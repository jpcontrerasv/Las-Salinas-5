    	...
    	<div id="contacto-head" class="container-fake">
        	...
        	<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 form">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-8">
                  <input id="textinput" name="textinput" type="text" placeholder="Tu nombre" class="form-control input-md" required="">
                  </div>
                </div>
                <!--nombre-->

                <div class="form-group">
                  <label class="col-md-3 control-label" for="textinput">Apellidos</label>  
                  <div class="col-md-8">
                  <input id="textinput" name="textinput" type="text" placeholder="Tus apellidos" class="form-control input-md" required="">
                  </div>
                </div>
                <!--apellidos-->
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-8">
                  <input id="textinput" name="textinput" type="email" placeholder="Tu email" class="form-control input-md" required="">
                  </div>
                </div>
                <!--email-->
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-8">
                  <input id="textinput" name="textinput" type="text" placeholder="Tu teléfono" class="form-control input-md" required="">
                  </div>
                </div>
                <!--telefono-->
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-8">
                  <input id="textinput" name="textinput" type="text" placeholder="Asunto de tu mensaje" class="form-control input-md" required="">
                  </div>
                </div>
                <!--email-->
                ...
                <!-- Textarea -->
                <div class="form-group">
                  <label class="col-md-3 control-label" for="textarea">Mensaje</label>
                  <div class="col-md-8">                     
                    <textarea class="form-control" id="textarea" name="textarea">Tu mensaje</textarea>
                  </div>
                </div>
