    ...
    <section id="blog" class="container-fluid no-column single">
		...
		<div class="container-fake">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 img">
            	<img src="img/blog/not-5.jpg" alt="">
            </div>
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 titular">
            	<div class="h2">
                	<h2>8 Ejemplos de arquitectura Sustentable</h2>
                </div>
                <p>La arquitectura sustentable, también denominada arquitectura sostenible, arquitectura verde, eco-arquitectura o arquitectura ambientalmente consciente, es un modo de concebir el diseño arquitectónico buscando optimizar recursos naturales y sistemas de la edificación de tal modo que disminuyan el impacto ambiental</p>
                <p><span class="fuente">Fuente: Sinembargo.mx  <a href="http://www.sinembargo.mx/17-02-2013/525439" target="_blank">http://www.sinembargo.mx/17-02-2013/525439</a></span></p>
            </div>
